...
namespace StellarisDaughter
{
    public class CompAbilityEffect_SpawnFlyOver : CompAbilityEffect
    {
        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            {
                Log.Message($"Error spawning fly over: {ex}");
            }
        }
        ...
        private void CreateStandardFlyOver(IntVec3 startPos, IntVec3 endPos)
        {
            ...
            if (flyOverDef == null)
            {
                Log.Message("No fly over def specified for standard fly over");
                return;
            }
        ...
        private void CreateGroundStrafingFlyOver(IntVec3 startPos, IntVec3 endPos, IntVec3 targetCell)
        {
            ...
            if (flyOverDef == null)
            {
                Log.Message("No fly over def specified for ground strafing fly over");
                return;
            }
        ...
        private void CreateSectorSurveillanceFlyOver(IntVec3 startPos, IntVec3 endPos)
        {
            ...
            if (flyOverDef == null)
            {
                Log.Message("No fly over def specified for sector surveillance fly over");
                return;
            }
