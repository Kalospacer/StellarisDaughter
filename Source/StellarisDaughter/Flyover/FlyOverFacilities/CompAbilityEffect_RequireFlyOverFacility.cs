...
namespace StellarisDaughter
{
    public class CompAbilityEffect_RequireFlyOverFacility : CompAbilityEffect
    {
        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            {
                Log.Message($"[RequireFlyOverFacility] No valid FlyOver found with required facility: {Props.requiredFacility}");
                return;
            }
        ...
        public override string ExtraLabelMouseAttachment(LocalTargetInfo target)
        {
            ...
            {
                // 捕获异常，避免UI崩溃
                Log.Message($"[RequireFlyOverFacility] Error in ExtraLabelMouseAttachment: {ex}");
                return "设施检查错误";
            }
        }
        ...
        private List<FlyOver> GetValidFlyOvers()
        {
            ...
            {
                Log.Message($"[RequireFlyOverFacility] Error in GetValidFlyOvers: {ex}");
