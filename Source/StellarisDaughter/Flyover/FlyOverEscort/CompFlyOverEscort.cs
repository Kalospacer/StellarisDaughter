    ...
    public class CompFlyOverEscort : ThingComp
    {
        ...
        private FlyOver CreateEscort(FlyOver mainFlyOver, EscortVisualData visualData)
        {
            try
            {
                ...
                if (escortDef == null)
                {
                    Log.Message("FlyOver Escort: No valid escort def found");
                    return null;
                }
                ...
                {
                    Log.Message("FlyOver Escort: Escort start or end position out of bounds");
                    return null;
                }
            ...
            {
                Log.Message($"Error creating FlyOver escort: {ex}");
                return null;
            }
        }
