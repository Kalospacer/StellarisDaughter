    ...
    public class CompSectorSurveillance : ThingComp
    {
        ...
        private void InitializeFactionCache()
        {
            ...
            else
            {
                ...
                {
                    Log.Message($"SectorSurveillance: CRITICAL - No faction found!");
                }
            }
        ...
        private Faction GetEffectiveFaction()
        {
            ...
            {
                Log.Message("SectorSurveillance: Cached faction is null, reinitializing...");
                InitializeFactionCache();
            }
        ...
        private void ExecuteAttacks()
        {
            ...
            foreach (Pawn enemy in targetsToProcess)
            {
                ...
                {
                    Log.Message($"SectorSurveillance: Failed to fire projectile at {enemy.Label}");
                }
            }
        ...
        private List<Pawn> GetEnemiesInSector()
        {
            ...
            if (map == null)
            {
                Log.Message("SectorSurveillance: Map is null!");
                return enemies;
            }
            ...
            if (flyOver == null)
            {
                Log.Message("SectorSurveillance: Parent is not a FlyOver!");
                return enemies;
            }
        ...
        private bool IsValidTarget(Pawn pawn)
        {
            ...
            {
                Log.Message($"SectorSurveillance: IsValidTarget - No effective faction found for {pawn.Label}");
                return false;
            }
        ...
        private bool IsInSector(IntVec3 targetPos)
        {
            ...
            if (flyOver == null)
            {
                Log.Message("SectorSurveillance: IsInSector - Parent is not a FlyOver!");
                return false;
            }
        ...
        private bool LaunchProjectileAt(Pawn target)
        {
            ...
            {
                Log.Message("SectorSurveillance: No projectile defined for sector surveillance");
                return false;
            }
            ...
            try
            {
                ...
                if (parent.Map == null)
                {
                    Log.Message("SectorSurveillance: Map is null during projectile launch");
                    return false;
                }

                if (!spawnCell.InBounds(parent.Map))
                {
                    Log.Message($"SectorSurveillance: Spawn cell {spawnCell} is out of bounds");
                    return false;
                }
                ...
                {
                    Log.Message("SectorSurveillance: Failed to spawn projectile - GenSpawn.Spawn returned null");
                    return false;
                }
            }
            catch (System.Exception ex)
            {
                Log.Message($"SectorSurveillance: Exception launching projectile: {ex}");
                Log.Message($"SectorSurveillance: Stack trace: {ex.StackTrace}");
                return false;
            }
        }
