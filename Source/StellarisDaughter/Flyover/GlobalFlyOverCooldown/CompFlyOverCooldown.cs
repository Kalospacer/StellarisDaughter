...
namespace StellarisDaughter
{
    public class CompFlyOverCooldown : ThingComp
    {
        ...
        {
            if (!IsOnCooldown)
                return "SD_FlyOverCooldown.Ready".Translate();
            
            return "SD_FlyOverCooldown.CooldownRemaining".Translate(CooldownTicksRemaining.ToStringTicksToPeriod());
        }
        ...
        public override string CompInspectStringExtra()
        {
            if (IsOnCooldown)
            {
                return "SD_FlyOverCooldown.BombardmentFacilityStatus".Translate(GetCooldownStatus());
            }
            return "SD_FlyOverCooldown.BombardmentFacilityReady".Translate();
        }
    }
