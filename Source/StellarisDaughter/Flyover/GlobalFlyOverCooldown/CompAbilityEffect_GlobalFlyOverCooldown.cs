...
namespace StellarisDaughter
{
    public class CompAbilityEffect_GlobalFlyOverCooldown : CompAbilityEffect
    {
        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            {
                Log.Message($"[GlobalFlyOverCooldown] No available FlyOver with BombardmentFacility found");
                return;
            }
            ...
            {
                Log.Message($"[GlobalFlyOverCooldown] Selected FlyOver has no CompFlyOverFacilities");
                return;
            }
        ...
        public override bool GizmoDisabled(out string reason)
        {
            ...
            {
                reason = "SD_GlobalFlyOverCooldown.CannotUseOutsideMap".Translate();
                return true;
            }
            ...
            if (availableFlyOvers.Count == 0)
            {
                reason = "SD_GlobalFlyOverCooldown.NoAvailableFacilities".Translate(totalFlyOvers.Count);
                return true;
            }
        ...
        public override string ExtraLabelMouseAttachment(LocalTargetInfo target)
        {
            try
            {
                ...
                return "SD_GlobalFlyOverCooldown.FacilityStatus".Translate(availableFlyOvers.Count, cooldownFlyOvers);
            }
            catch (System.Exception ex)
            {
                Log.Message($"[GlobalFlyOverCooldown] Error in ExtraLabelMouseAttachment: {ex}");
                return "SD_GlobalFlyOverCooldown.FacilityStatusError".Translate();
            }
        }
        ...
        public override string ExtraTooltipPart()
        {
            ...
            var facilityDesc = "\n" + "SD_GlobalFlyOverCooldown.FacilityStatusDetailed".Translate(availableFlyOvers.Count, cooldownFlyOvers);
            ...
            if (availableFlyOvers.Count > 0)
            {
                ...
                {
                    facilityDesc += "\n" + "SD_GlobalFlyOverCooldown.CooldownTime".Translate(Props.globalCooldownTicks.ToStringTicksToPeriod());
                }
            }
        ...
        public override bool Valid(LocalTargetInfo target, bool throwMessages = false)
        {
            ...
            if (availableFlyOvers.Count == 0)
            {
                if (throwMessages)
                {
                    Messages.Message("SD_GlobalFlyOverCooldown.NoAvailableFacilitiesSimple".Translate(), parent.pawn, MessageTypeDefOf.RejectInput);
                }
                return false;
            }
        ...
        private List<FlyOver> GetAvailableFlyOvers()
        {
            ...
            {
                Log.Message($"[GlobalFlyOverCooldown] Error in GetAvailableFlyOvers: {ex}");
        ...
        private List<FlyOver> GetTotalFlyOvers()
        {
            ...
            {
                Log.Message($"[GlobalFlyOverCooldown] Error in GetTotalFlyOvers: {ex}");
                return new List<FlyOver>();
            }
        }
        ...
        private void SetCooldown(FlyOver flyOver, int cooldownTicks)
        {
            ...
            if (cooldownComp == null)
            {
                Log.Message($"[GlobalFlyOverCooldown] FlyOver at {flyOver.Position} has no CompFlyOverCooldown");
                return;
            }
